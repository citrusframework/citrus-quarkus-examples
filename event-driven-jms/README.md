# Citrus Quarkus Examples - Event Driven Jms
...
You can then execute your native executable with: `./target/event-driven-jms-1.0.0-SNAPSHOT-runner`
...
- ActiveMQ Artemis ([guide](https://docs.quarkiverse.io/quarkus-artemis/dev/quarkus-artemis-jms.html)): Connect Quarkus with Artemis JMS
